...
* Custom renderer.
*/
public class FilledXYAreaRenderer extends XYAreaRenderer {
     ...
     */
    public FilledXYAreaRenderer(int type) {
        this(type, null, null);
    }
     ...
     */
    public FilledXYAreaRenderer(int type, XYToolTipGenerator toolTipGenerator, 
